...
*/
	...
	.delivery1_btn,
	.delivery2_btn,
	.delivery3_btn  { font-size:16px; background:#fff; border:1px solid #999; margin-left:10px; }
						...
						<c:if test="${status.first}">
							...
							<div class="deliveryChange">
								<form role="form" method="post" class="deliveryForm">
									...
									<button type="button" class="delivery1_btn">주문 확인</button>
									<button type="button" class="delivery2_btn">배송 중</button>
									<button type="button" class="delivery3_btn">배송 완료</button>
