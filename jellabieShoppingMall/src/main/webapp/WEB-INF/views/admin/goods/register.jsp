...
<div id="root">
	...
	<section id="container">
		<div id="container_box" class="container_reg">
			<h2>상품 등록</h2>
			
			<form id="goodsRegForm" role="form" method="post" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="inputArea">
				...
				<script>
					var ckeditor_config = {
							...
							/* filebrowserUploadUrl : "../../../resouces/ckUpload" */
					};
