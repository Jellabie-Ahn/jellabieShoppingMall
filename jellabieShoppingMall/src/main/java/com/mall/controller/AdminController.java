...
//			printWriter.println("{\"filename\" : \""+fileName+"\", \"uploaded\" : 1, \"url\":\""+fileUrl+"\"}");
	...
	public void getAdminMemberList(Model model) throws Exception {
		...
		List<MemberVO> memberList = adminService.memberList();  // GoodsVO형태의 List형 변수 list 선언
		
		model.addAttribute("memberList", memberList);  // 변수 list의 값을 list 세션에 부여
		}
